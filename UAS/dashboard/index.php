<?php
    ...
    if (!isset($_SESSION['id_users'])) {
        ...
        $query= mysqli_query($conn, "SELECT b.* FROM course_user AS a
    INNER JOIN course AS b ON a.id_course = b.id_course
    WHERE a.id_users = '".$_SESSION['id_users']."'");
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <p>Berikut ini adalah daftar kelas yang kamu ikuti.</p>
            <div class="row">
                <?php 
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                    ...
                                    $query = mysqli_query($conn, "SELECT * FROM course_user WHERE id_users='".$_SESSION['id_users']."' AND id_course='".$course['id_course']."'");
                                    $course_user = mysqli_fetch_assoc($query);


                                    $query = mysqli_query($conn, "SELECT COUNT(b.id_progress_user) as count FROM course_user AS a INNER JOIN progress_user AS b ON a.id_course_user = b.id_course_user WHERE a.id_course_user = '".$course_user['id_course_user']."' AND b.status = 1");
                                    $jml_centang = mysqli_fetch_assoc($query);

                                    $persen = round($jml_centang['count']/$jml_chapter['count'] * 100);
                                ?>
                                <p class="card-text"><?=$jml_chapter['count'];?> Chapter</p>
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" style="width: <?=$persen;?>%;" aria-valuenow="<?=$persen;?>" aria-valuemin="0"
